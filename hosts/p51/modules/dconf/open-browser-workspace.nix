{pkgs}:
pkgs.writeShellScript "browser-workspace-script" ''
  #!/bin/bash
  # Switch to workspace 1 (Browser)
  wmctrl -s 0

  # Launch 1Password & Firefox with the same tabs as orion + github.com
