...
1. Navigate to the first interesting file / hunk
1. Add a comment explaining what's happening and why
1. If you already have several notes ready, prefer one `comment apply` batch over many separate shell invocations
1. Summarize when done
